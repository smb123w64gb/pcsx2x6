...
END_MODULE
MODULE(secrman)
	EXPORT( 4, SecrSetMcCommandHandler)
	EXPORT( 5, SecrSetMcDevIDHandler)
	EXPORT( 6, SecrAuthCard)
	EXPORT( 7, SecrResetAuthCard)
	EXPORT( 8, SecrCardBootHeader)
	EXPORT( 9, SecrCardBootBlock)
	EXPORT(10, SecrCardBootFile)
	EXPORT(11, SecrDiskBootHeader)
	EXPORT(12, SecrDiskBootBlock)
	EXPORT(13, SecrDiskBootFile)
	EXPORT(14, SecrDownloadHeader)
	EXPORT(15, SecrDownloadBlock)
	EXPORT(16, SecrDownloadFile)
	EXPORT(17, SecrDownloadGetKbit)
	EXPORT(18, SecrDownloadGetKc)
	EXPORT(19, SecrDownloadGetICVPS2)
	EXPORT(20, SecrAuthDongle)
END_MODULE
MODULE(mcman)
	EXPORT(  5, McDetectCard)
	EXPORT(  6, McOpen)
	EXPORT(  7, McClose)
	EXPORT(  8, McRead)
	EXPORT(  9, McWrite)
	...
	EXPORT( 14, McFlush)
	EXPORT( 15, McChDir)
	EXPORT( 16, McSetFileInfo)
	EXPORT( 17, McEraseBlock)
	EXPORT( 18, McReadPage)
	EXPORT( 19, McWritePage)
	EXPORT( 20, McDataChecksum)
	EXPORT( 21, McDetectCard2)
	EXPORT( 22, McGetFormat)
	EXPORT( 23, McGetEntSpace)
	EXPORT( 24, McReplaceBadBlock)
	EXPORT( 25, McCloseAll)
	EXPORT( 29, McReadPS1PDACard)
	EXPORT( 30, McWritePS1PDACard)
	EXPORT( 36, McUnformat)
	EXPORT( 37, McRetOnly)
	EXPORT( 38, McGetFreeClusters)
	EXPORT( 39, McGetMcType)
	EXPORT( 40, McSetPS1CardFlag)
	EXPORT( 42, McGetModuleInfo)
	EXPORT( 43,  McGetCardSpec)
	EXPORT( 44, McGetFATentry)
	EXPORT( 45, McCheckBlock)
	EXPORT( 46, McSetFATentry)
	EXPORT( 47, McReadDirEntry)
	EXPORT( 48, Mc1stCacheEntSetWrFlagOff)
	EXPORT( 49, McCreateDirentry)
	EXPORT( 50, McReadCluster)
	EXPORT( 51, McFlushCache)
	EXPORT( 52, McSetDirEntryState)
	EXPORT( 53, CantRemember)
	EXPORT( 54, McGetSemaphore)
	EXPORT( 55, UnknownPageRead)
	EXPORT( 56, nmConquestPageErase)
	EXPORT( 57, nmConquestPageRead)
	EXPORT( 58, nmConquestPageWrite)
	EXPORT( 59, nmConquestAuthCard)
	EXPORT( 60, _dummy)
END_MODULE
MODULE(thbase)
...
MODULE(acjv)
	EXPORT( 4, acJvModuleRestart)
	EXPORT( 5, acJvModuleStart)
	EXPORT( 6, acJvModuleStatus)
	EXPORT( 7, acJvModuleStop)
	EXPORT( 8, acJvRead)
	EXPORT( 9, acJvWrite)
	EXPORT(10, acJvGet)
	EXPORT(11, acJvPut)
...
MODULE(accore)
	EXPORT(4 , acDmaModuleRestart)
	EXPORT(5 , acDmaModuleStart)
	EXPORT(6 , acDmaModuleStatus)
	EXPORT(7 , acDmaModuleStop)
	EXPORT(8 , acDmaSetup)
	EXPORT(9 , acDmaRequest)
	EXPORT(10, acDmaRequestI)
	EXPORT(11, acDmaCancel)
	EXPORT(12, acDmaCancelI)
	EXPORT(13, acIntrModuleRestart)
	EXPORT(14, acIntrModuleStart)
	EXPORT(15, acIntrModuleStatus)
	EXPORT(16, acIntrModuleStop)
	EXPORT(17, acIntrRegister)
	EXPORT(18, acIntrRelease)
	EXPORT(19, acIntrEnable)
	EXPORT(20, acIntrDisable)
	EXPORT(21, acIntrClear)
END_MODULE

MODULE(accdvd)
	EXPORT( 4, acCdvdModuleRestart)
	EXPORT( 5, acCdvdModuleStart)
	EXPORT( 6, acCdvdModuleStatus)
	EXPORT( 7, acCdvdModuleStop)
	EXPORT( 8, _retonly)
	EXPORT( 9, _retonly)
	EXPORT(10, sceCdSearchFile)
	EXPORT(11, sceCdRead)
	EXPORT(12, _retonly)
	EXPORT(13, sceCdCallback)
	EXPORT(14, sceCdTrayReq)
	EXPORT(15, sceCdGetReadPos)
	EXPORT(16, sceCdSync)
	EXPORT(17, sceCdInit)
	EXPORT(18, _retonly)
	EXPORT(19, sceCdDiskReady)
	EXPORT(20, sceCdGetError)
	EXPORT(21, sceCdGetDiskType)
	EXPORT(22, sceCdStatus)
	EXPORT(23, _retonly)
	EXPORT(24, sceCdGetToc)
	EXPORT(25, sceCdSeek)
	EXPORT(26, sceCdStandby)
	EXPORT(27, sceCdStop)
	EXPORT(28, sceCdPause)
	EXPORT(29, sceCdStInit)
	EXPORT(30, sceCdStStart)
	EXPORT(31, sceCdStSeek)
	EXPORT(32, sceCdStStop)
	EXPORT(33, sceCdStRead)
	EXPORT(34, sceCdStStat)
	EXPORT(35, sceCdStPause)
	EXPORT(36, sceCdStResume)
	EXPORT(37, sceCdMmode)
	EXPORT(38, _retonly)
	EXPORT(39, _retonly)
	EXPORT(40, _retonly)
	EXPORT(41, cdc_module_restart)
	EXPORT(42, cdc_module_start)
	EXPORT(43, cdc_module_status)
	EXPORT(44, cdc_module_stop)
	EXPORT(45, cdc_geterrno)
	EXPORT(46, cdc_getfno)
	EXPORT(47, cdc_seterrno)
	EXPORT(48, cdc_xfer)
	EXPORT(49, cdc_error)
	EXPORT(50, cdc_lookup)
	EXPORT(51, cdc_medium)
	EXPORT(52, cdc_readtoc)
	EXPORT(53, cdc_ready)
	EXPORT(54, cdc_sync)
	EXPORT(55, cdc_pause)
	EXPORT(56, cdc_standby)
	EXPORT(57, cdc_stat)
	EXPORT(58, cdc_stop)
	EXPORT(59, cdc_tray)
	EXPORT(60, cdc_seek)
	EXPORT(61, cdc_read)
	EXPORT(62, cdc_getpos)
	EXPORT(63, cdc_inits)
	EXPORT(64, cdc_seeks)
	EXPORT(65, cdc_reads)
	EXPORT(66, cdc_starts)
	EXPORT(67, cdc_stats)
	EXPORT(68, cdc_stops)
	EXPORT(69, cdc_pauses)
	EXPORT(70, cdc_resumes)
END_MODULE

MODULE(atad) //ACATAD.IRX
	EXPORT( 2, sceAtaTerminate)
	EXPORT( 4, sceAtaInit)
	EXPORT( 5, sceAtaSoftReset)
	EXPORT( 6, sceAtaExecCmd)
	EXPORT( 7, sceAtaWaitResult)
	EXPORT( 8, sceAtaGetError)
	EXPORT( 9, sceAtaDmaTransfer)
	EXPORT(10, sceAtaSecuritySetPassword)
	EXPORT(11, sceAtaSecurityUnLock)
	EXPORT(12, sceAtaSecurityEraseUnit)
	EXPORT(13, sceAtaIdle)
	EXPORT(14, sceAtaGetSceId)
	EXPORT(15, sceAtaSmartReturnStatus)
	EXPORT(16, sceAtaSmartSaveAttr)
	EXPORT(17, sceAtaFlushCache)
	EXPORT(18, sceAtaIdleImmediate)
END_MODULE

MODULE(acata)
	EXPORT( 4, acAtaModuleRestart)
	EXPORT( 5, acAtaModuleStart)
	EXPORT( 6, acAtaModuleStatus)
	EXPORT( 7, acAtaModuleStop)
	EXPORT( 8, acAtaSetup)
	EXPORT( 9, acAtaRequest)
	EXPORT(10, acAtaRequestI)
	EXPORT(11, acAtaReply)
	EXPORT(12, acAtaStatus)
	EXPORT(13, acAtapiSetup)
	EXPORT(14, acAtapiRequest)
	EXPORT(15, acAtapiRequestI)
	EXPORT(16, acAtapiStatus)
	EXPORT(17, ata_probe)
END_MODULE

MODULE(acdev) // rom0:ACDEV
	EXPORT(4, SetAcMemDelayReg)
	EXPORT(5, GetAcMemDelayReg)
	EXPORT(6, SetAcIoDelayReg)
	EXPORT(7, GetAcIoDelayReg)
END_MODULE

MODULE(acflash)
	EXPORT( 4, acFlashModuleRestart)
	EXPORT( 5, acFlashModuleStart)
	EXPORT( 6, acFlashModuleStatus)
	EXPORT( 7, acFlashModuleStop)
	EXPORT( 8, acFlashStart)
	EXPORT( 9, acFlashStatus)
	EXPORT(10, acFlashStop)
	EXPORT(11, acFlashInfo)
	EXPORT(12, acFlashErase)
	EXPORT(13, acFlashProgram)
	EXPORT(14, acFlashRead)
	EXPORT(15, acFlashVerify)
END_MODULE

MODULE(acmem)
	EXPORT(4, acMemModuleRestart)
	EXPORT(5, acMemModuleStart)
	EXPORT(6, acMemModuleStatus)
	EXPORT(7, acMemModuleStop)
	EXPORT(8, acMemSetup)
	EXPORT(9, acMemSend)
	EXPORT(10, acMemReceive)
	EXPORT(11, acMemWait)
	EXPORT(12, _retonly)
	EXPORT(13, _retonly)
END_MODULE
...
MODULE(acram)
	EXPORT( 4, acRamModuleRestart)
	EXPORT( 5, acRamModuleStart)
	EXPORT( 6, acRamModuleStatus)
	EXPORT( 7, acRamModuleStop)
	EXPORT( 8, acRamSetup)
	EXPORT( 9, acRamRead)
	EXPORT(10, acRamReadI)
	EXPORT(11, acRamWrite)
	EXPORT(12, acRamWriteI)
END_MODULE

MODULE(acsram)
	EXPORT(4, acSramModuleRestart)
	EXPORT(5, acSramModuleStart)
	EXPORT(6, acSramModuleStatus)
	EXPORT(7, acSramModuleStop)
	EXPORT(8, acSramRead)
	EXPORT(9, acSramWrite)
END_MODULE

MODULE(actimer)
	EXPORT(4, acTimerModuleStart)
	EXPORT(5, acTimerModuleRestart)
	EXPORT(6, acTimerModuleStop)
	EXPORT(7, acTimerModuleStatus)
	EXPORT(8, acTimerAdd)
	EXPORT(9, acTimerRemove)
END_MODULE

MODULE(acuart)
	EXPORT( 4, acUartModuleRestart)
	EXPORT( 5, acUartModuleStart)
	EXPORT( 6, acUartModuleStatus)
	EXPORT( 7, acUartModuleStop)
	EXPORT( 8, acUartRead)
	EXPORT( 9, acUartWrite)
	EXPORT(10, acUartWait)
	EXPORT(11, acUartGetAttr)
	EXPORT(12, acUartSetAttr)
END_MODULE
